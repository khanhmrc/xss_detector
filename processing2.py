...
vec_dir="file\\word2vec2.pickle"
pre_datas_check="file\\datas_check.csv"
process_datas_dir="file\\process2_datas.pickle"

#Tiền xử lí, gộp xssed và normal data, gán nhãn
def pre_process():
    ...
    check_data=[]
    with open("data\\mutated_payloads.csv","r",encoding="utf-8") as f:
        reader=csv.reader(f)
    ...
    print("Độ dài của mỗi mẫu dữ liệu sau khi tiền xử lý là:", input_num)
